...
#rev = fake_wav_full_B.permute(list(range(len(fake_wav_full_B.shape)))[::-1])
                    self.logger.log_audio(
                        real_wav_full_A.permute(list(range(len(real_wav_full_A.shape)))[::-1]), "real_speaker_A_audio", self.sample_rate)
                    self.logger.log_audio(
                        fake_wav_full_A.permute(list(range(len(fake_wav_full_A.shape)))[::-1]), "fake_speaker_A_audio", self.sample_rate)
                    self.logger.log_audio(
                        real_wav_full_B.permute(list(range(len(real_wav_full_B.shape)))[::-1]), "real_speaker_B_audio", self.sample_rate)
                    self.logger.log_audio(
                        fake_wav_full_B.permute(list(range(len(fake_wav_full_B.shape)))[::-1]), "fake_speaker_B_audio", self.sample_rate)
...
#python3 -W ignore::UserWarning -m mask_cyclegan_vc.test \
#    --name mask_cyclegan_vc_VCC2SF3_VCC2TF1 \
#    --save_dir results/ \
#    --preprocessed_data_dir vcc2018_preprocessed/vcc2018_training \
#    --gpu_ids 0 \
#    --speaker_A_id VCC2SM5 \
#    --speaker_B_id VCC2TM3 \
#    --ckpt_dir /results/debug/ckpts \ 
#    --load_epoch 500 \
